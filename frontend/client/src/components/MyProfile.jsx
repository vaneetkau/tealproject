  ...
  return (
    <>
      ...
      <div className="auth-form-container">
        <hr />
        <h3>About Me:-</h3>
        <p>A highly motivated person, ambitious to develop experiences on discovering skills and pursuing to get scholarship for achieving career goals. Good at academic skills and athlete.</p>
        {/* <h3>Skills:-</h3>
        <ul>
          <li>UI/UX Design</li>
          <li>Branding</li>
