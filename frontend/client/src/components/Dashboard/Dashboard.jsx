...
const Dashboard = () => {
  ...
  return (
    <div className="container-fluid bgcolor-offwhite">
      <div className="row">
        <div className="col-lg-2 col-md-3" style={{ paddingLeft: 0 }}>
          <Sidebar />
        </div>
        <div className="col-lg-10 col-md-9 bgcolor-offwhite">
                  ...
                  <div className="col-lg-12">
                    <div className="d-flex flex-row container-lg p-3 bg-white border border-radius">
                      <div className="mt-2 p-2">
                        ...
                        <p className="lh-base fs-6">You are up to date with your payments, your next payment will be 9th November.</p>
                      </div>
                      <img className="align-item-center img-fluid border border-radius m-3" style={{ maxWidth: "170px" }} src={pig} alt="" />
                    </div>
                    <div className="row mt-5 p-0 align-items-stretch">
                      <div className="col-lg-3 col-md-3 col-sm-3 mb-2">
                        <div className="card border-radius w-100 m-0 p-4" style={{ maxHeight: "130px" }}>
                          <div className="card-body color-primary p-0">
                            <h2 className="card-title text-center text-lg">5%</h2>
                            <p className="card-text text-center text-md">Interest rate</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-3 col-sm-3 mb-2">
                        <div className="card border-radius w-100 m-0 p-4" style={{ maxHeight: "130px" }}>
                          <div className="card-body color-primary p-0">
                            <h2 className="card-title text-center text-lg">700</h2>
                            <p className="card-text text-center text-md">Credit Score</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-3 col-sm-3 mb-2">
                        <div className="card border-radius w-100 m-0 p-4" style={{ maxHeight: "130px" }}>
                          <div className="card-body color-primary p-0">
                            ...
                            <p className="card-text text-center text-md">Savings</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-3 col-sm-3 mb-2">
