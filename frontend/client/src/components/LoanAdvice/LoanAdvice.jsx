...
const LatestNews = () => {
  ...
  const fetchData = async () => {
    ...
    'https://gnews.io/api/v4/search?top-headlines?category=educationloan&q=loan&token=235bc2d596033d0cef9a8952b244d51c');
      ...
      <div className="row">
        ...
        <div className="col-lg-10 col-md-9">
          <>
            ...
            <h1 className="text-left my-3 heading1">Loan Advice</h1>
